...
This document describes the legacy Babylon.js scaffold that originally lived under
`app/`. The current project uses Vite (see the repository root `README.md`), but the
utility servers remain handy for quick static hosting and error logging.
...
3. Visit <http://127.0.0.1:8080/index.html> (or your Vite build in `dist/`) and confirm the scene renders.
